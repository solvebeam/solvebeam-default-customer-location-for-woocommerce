...
- Updated build/tooling to match the SolveBeam WordPress plugin boilerplate conventions (PHP 8.3, Jetpack autoloader, Composer/npm scripts, `.wp-env.json`, PHPCS, Rector).
- Added `declare(strict_types=1);` to all PHP files.
- Untracked `composer.lock` and `package-lock.json`.
